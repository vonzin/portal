...
// FORMS
    ...
    function print_ob_text($objattr, $w, $h, $texto, $rtlalign, $k, $blockdir) {
        ...
        if ($this->mpdf->useActiveForms) {
            ...
            $this->SetFormText($w, $h, $objattr['fieldname'], $val, $val, $objattr['title'], $flags, $fieldalign, false, (isset($objattr['maxlength']) ? $objattr['maxlength'] : false), $js,
            ...
            $this->mpdf->Cell($w, $h, $texto, 1, 0, $rtlalign, 1, '', 0, $this->form_element_spacing['input']['inner']['h'] / $k, $this->form_element_spacing['input']['inner']['h'] / $k, 'M', 0,
                              false, $OTLdata);
    ...
    function print_ob_textarea($objattr, $w, $h, $texto, $rtlalign, $k, $blockdir) {
        ...
        if ($this->mpdf->useActiveForms) {
            ...
            $this->SetFormText($w, $h, $objattr['fieldname'], $texto, $texto, (isset($objattr['title']) ? $objattr['title'] : ''), $flags, $fieldalign, false, -1, $js,
                                                                                     (isset($objattr['background-col']) ? $objattr['background-col'] : false),
                                                                                            (isset($objattr['border-col']) ? $objattr['border-col'] : false));
            $this->mpdf->SetTColor($this->mpdf->ConvertColor(0));
        }
    ...
    function print_ob_select($objattr, $w, $h, $texto, $rtlalign, $k, $blockdir) {
        ...
        if ($this->mpdf->useActiveForms) {
            ...
            $this->mpdf->Cell($w - ($this->mpdf->FontSize * 1.4), $h, $texto, 1, 0, $rtlalign, 1, '', 0, $this->form_element_spacing['select']['inner']['h'] / $k,
    ...
    function print_ob_imageinput($objattr, $w, $h, $texto, $rtlalign, $k, $blockdir) {
        ...
        if ($this->mpdf->useActiveForms) {
            ...
            $this->SetJSButton($w, $h, $objattr['fieldname'], (isset($objattr['value']) ? $objattr['value'] : ''), $js, $objattr['ID'], $objattr['title'], $flags,
                                                                     (isset($objattr['Indexed']) ? $objattr['Indexed'] : false));
        }
        else {
            $this->mpdf->y = $objattr['INNER-Y'];
            $this->mpdf->_out(sprintf("q %.3F 0 0 %.3F %.3F %.3F cm /I%d Do Q", $objattr['INNER-WIDTH'] * _MPDFK, $objattr['INNER-HEIGHT'] * _MPDFK, $objattr['INNER-X'] * _MPDFK,
    ...
    function print_ob_button($objattr, $w, $h, $texto, $rtlalign, $k, $blockdir) {
        ...
        if ($this->mpdf->useActiveForms) {
            ...
            if (isset($objattr['subtype']) && $objattr['subtype'] == 'RESET') {
                ...
                $this->SetFormReset($w, $h, $objattr['fieldname'], $objattr['value'], $objattr['title'], $flags, (isset($objattr['background-col']) ? $objattr['background-col'] : false),
                                                                                                                        (isset($objattr['border-col']) ? $objattr['border-col'] : false),
                ...
                $this->SetFormButtonText($objattr['value']);
                $this->SetFormSubmit($w, $h, $objattr['fieldname'], $objattr['value'], $url, $objattr['title'], $type, $method, $flags,
                                     (isset($objattr['background-col']) ? $objattr['background-col'] : false), (isset($objattr['border-col']) ? $objattr['border-col'] : false),
                                                                                                                      (isset($objattr['noprint']) ? $objattr['noprint'] : false));
            }
                ...
                $this->SetJSButton($w, $h, $objattr['fieldname'], $objattr['value'], $js, 0, $objattr['title'], $flags, false, (isset($objattr['background-col']) ? $objattr['background-col'] : false),
                                                                                                                                      (isset($objattr['border-col']) ? $objattr['border-col'] : false),
                                                                                                                                             (isset($objattr['noprint']) ? $objattr['noprint'] : false));
            }
            $this->mpdf->SetTColor($this->mpdf->ConvertColor(0));
    ...
    function print_ob_radio($objattr, $w, $h, $texto, $rtlalign, $k, $blockdir, $x, $y) {
        ...
        if ($this->mpdf->useActiveForms) {
            ...
            $this->SetRadio($w, $h, $objattr['fieldname'], $objattr['value'], (isset($objattr['title']) ? $objattr['title'] : ''), $checked, $flags,

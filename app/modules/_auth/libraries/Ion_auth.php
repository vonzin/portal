...
class Ion_auth {
    ...
    public function __construct() {
        ...
        if (!$this->db->table_exists($this->config->item('ion_auth')['tables']['users'])) {
            $this->criar_tabelas();
            exit;
        }
    ...
    private function criar_tabelas() {
        ...
        $this->dbforge->create_table($this->config->item('ion_auth')['tables']['users'], true);
        ...
        $this->dbforge->add_field('id');
        $this->dbforge->add_field($campos);
        $this->dbforge->create_table($this->config->item('ion_auth')['tables']['groups'], true);
        ...
        $this->dbforge->add_field('id');
        $this->dbforge->add_field($campos);
        $this->dbforge->create_table($this->config->item('ion_auth')['tables']['users_groups'], true);
        ...
        $this->dbforge->add_field('id');
        $this->dbforge->add_field($campos);
        $this->dbforge->create_table($this->config->item('ion_auth')['tables']['login_attempts'], true);
